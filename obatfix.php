...
<body>
    ...
    <section id="obat-section">
        ...
        <div class="container">
            <a href="form_tambah.php"><button class="add-btn mt-3 mb-4">Tambah Data</button></a>
        </div>
        <div class="container mt-4">
        <div class="row">
            <div class="col-12 mb-3">
                <input type="text" id="searchInput" class="form-control" placeholder="Cari obat berdasarkan nama">
                </div>
            </div>
        </div>
        <div class="container mt-4">
                    ...
                    <div class="card mb-5 obat-content" style="width: 18rem;">
                        ...
                        <div class="card-body card-content">
                            ...
                            <div class="mx-auto">
                                ...
                                <a href="delete.php?id=<?php echo $result['obat_id']; ?>"><button type="button"
